 ...
 */
require_once dirname(__FILE__) . '/MathLoader.php';
...
class Crypt_RSA_Key extends Crypt_RSA_ErrorHandler
{
     ...
     * @access public
     */
    public function __construct($modulus, $exp, $key_type, $wrapper_name = 'default', $error_handler = '')
    //function Crypt_RSA_Key($modulus, $exp, $key_type, $wrapper_name = 'default', $error_handler = '')
    {
        ...
        $this->_modulus = $this->_math_obj->hex2bin($modulus);
        $this->_exp = $this->_math_obj->hex2bin($exp);
